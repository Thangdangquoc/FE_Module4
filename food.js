...
function displayTable(data){
    ...
    for (let i = 0; i < data.length; i++) {
        ...
        //     // // '                            <div> <img  src="'+"http://localhost:8080/Image/" + data[i].imageUrl  +'"  width="100" height="100"></div>' +
        //     // '                            <ul class="featured__item__pic__hover">\n' +
        //     // '                                <li><a href="#"><i class="fa fa-heart"></i></a></li>' +
        //     // '                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>' +
        //     // '                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>' +
        ...
        //     // '                        </div>\n' +
        //     '                        <div class="featured__item__text">' +
        //     '                            <h6><a href="#" onclick="showEditForm()">'+data[i].name+'</a></h6>' +
        //     '                            <h5>'+ data[i].price +"VNĐ"+'</h5>   ' +
        //     '                        </div>\n' +
        //     // '                    </div>\n' +
        //     '                </div>'
...
function listCategory1(){
    $.ajax({
        ...
        success: function (listCategory){
            result = ""
            for (let i = 0; i < listCategory.length; i++) {
                result += "<li><a value="+listCategory[i].id+">"+ listCategory[i].name +"</a></li>"
            }
